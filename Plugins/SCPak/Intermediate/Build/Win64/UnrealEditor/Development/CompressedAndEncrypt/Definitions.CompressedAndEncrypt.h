#undef COMPRESSEDANDENCRYPT_API
...
#define UE_PROJECT_NAME TreasureChestDemo
#define UE_TARGET_NAME TreasureChestDemoEditor
...
#define COMPRESSEDANDENCRYPT_API DLLEXPORT
